...
const DESTINATIONS = ['USA', 'EU', 'China', 'Japan', 'Korea', 'Middle East', 'Australia', 'Canada']
const PRODUCT_GRADES = ['W180', 'W210', 'W240', 'W320', 'W450', 'WS', 'LP', 'SP', 'BB']
...
const ExportForm = ({ onSubmit }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.containerNo || !formData.destination || !formData.quantity) {
  ...
  return (
    <Card title="🚢 Nhập liệu Export" className="bg-green-50">
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <label className="block text-sm font-medium mb-1">Ngày xuất <span className="text-red-500">*</span></label>
            <input
              type="date"
              name="date"
              value={formData.date}
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              required
              placeholder="VD: EFGH7654321"
              className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
            />
          </div>

          <div>
            <label className="block text-sm font-medium mb-1">Thị trường đích <span className="text-red-500">*</span></label>
            <select
              name="destination"
          ...
          <div>
            ...
            >
              ...
              {PRODUCT_GRADES.map(g => <option key={g} value={g}>{g}</option>)}
            </select>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <select
                ...
                value={formData.unit}
                onChange={handleChange}
                className="w-20 px-2 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
              >
          ...
          <div>
            <label className="block text-sm font-medium mb-1">Ngày đóng hàng</label>
            <input
              type="date"
              name="packingDate"
